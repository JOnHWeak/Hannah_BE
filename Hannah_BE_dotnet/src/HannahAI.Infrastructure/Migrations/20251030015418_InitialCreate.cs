    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIResponseRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIResponseRatings_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MindMaps_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserConceptMasteries_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserConceptMasteries_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSubjectProgresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSubjectProgresses_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSubjectProgresses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MindMapCycles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MindMapCycles_MindMaps_MindMapId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIResponseRatings_UserId",
                table: "AIResponseRatings",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MindMapCycles_MindMapId",
                table: "MindMapCycles",
                column: "MindMapId");

            migrationBuilder.CreateIndex(
                name: "IX_MindMaps_SubjectId",
                table: "MindMaps",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserConceptMasteries_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSubjectProgresses_SubjectId",
                table: "UserSubjectProgresses",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSubjectProgresses_UserId",
                table: "UserSubjectProgresses",
                column: "UserId");
        }
